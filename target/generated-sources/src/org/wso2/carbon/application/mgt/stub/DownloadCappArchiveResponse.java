...
/**
 * DownloadCappArchiveResponse.java
 *
 ...
 */
        ...
        public  class DownloadCappArchiveResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://mgt.application.carbon.wso2.org",
                "downloadCappArchiveResponse",
                "ns2");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":downloadCappArchiveResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "downloadCappArchiveResponse",
    ...
    public static class Factory{
        ...
        */
        public static DownloadCappArchiveResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DownloadCappArchiveResponse object =
                new DownloadCappArchiveResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"downloadCappArchiveResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DownloadCappArchiveResponse)org.wso2.carbon.application.mgt.stub.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
