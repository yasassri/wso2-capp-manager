 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listAllApplications",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listAllApplications",
    ...
    public static class Factory{
        ...
        */
        public static ListAllApplications parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListAllApplications object =
                new ListAllApplications();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listAllApplications".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListAllApplications)org.wso2.carbon.application.mgt.stub.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
